...
class CandidateController extends Controller
{
    ...
    public function generateurl(Request $request)
    {
        try{
            ...
            $found = Candidate::where(['email'=>$data['email'], 'password'=>$data['password']])->first();
            ...
            return response($quizurl, 200);
            }
        }
        catch(Exception $e){
            $error = array(
                'success' => false,
                'fields' => 'Both Email and Password fields are Required To Genrate URL',
                'email' => 'Please Enter a Valid Email',
                'password' => 'Please Enter a Password Min(6), Max(32) Characters Long',
                'message' => 'There was an error: {'.
                    $e->getMessage().'}'
